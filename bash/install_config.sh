...
../src/bin/Debug/net10.0/dnproto /command InstallConfig /datadir ../data/ /pdshostname $PDS_HOST_NAME /availableuserdomain $AVAILABLE_USER_DOMAIN /userhandle $USER_HANDLE /userdid $USER_DID /useremail $USER_EMAIL
